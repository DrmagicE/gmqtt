...
func (mr *MockqueueMockRecorder) ack(id any) *gomock.Call {
...
func (mr *MockqueueMockRecorder) add(event any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockqueueMockRecorder) setReadPosition(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
