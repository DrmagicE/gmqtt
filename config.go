...
type Config struct {
	...
	MaxPacketSize           uint32        `yaml:"max_packet_size" validate:"max=65535"`
	ReceiveMax              uint16        `yaml:"server_receive_maximum" validate:"max=65535"`
	...
	MaximumQoS              uint8         `yaml:"maximum_qos" validate:"max=2"`
