...
func (m *MockServer) ApplyConfig(arg0 config.Config) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ApplyConfig", arg0)
}

// ApplyConfig indicates an expected call of ApplyConfig.
func (mr *MockServerMockRecorder) ApplyConfig(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyConfig", reflect.TypeOf((*MockServer)(nil).ApplyConfig), arg0)
}
