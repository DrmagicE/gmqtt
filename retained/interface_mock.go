...
func (mr *MockStoreMockRecorder) AddOrReplace(message any) *gomock.Call {
...
func (mr *MockStoreMockRecorder) GetMatchedMessages(topicFilter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetRetainedMessage(topicName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Remove(topicName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
